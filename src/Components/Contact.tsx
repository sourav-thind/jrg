    ...
    <div >
      ...
      <div className='bg-Color2  flex mx-auto justify-center  h-[90vh] md:h-[90vh]  '>
        ...
        <div className='flex flex-col items-center  space-y-8 md:space-y-2 '>
          ...
          <h2 className=' text-Color1 justify-center items-center  font-semibold text-base md:text-xl md:font-bold uppercase px-4'> <span> Looking for the perfect solution?</span> <span className='decoration-Color1 underline underline-offset-4 text-drwht'> We&apos;ve got you covered.</span> </h2>
          <div className='flex flex-col md:flex-row md:pt-16 md:space-x-[8rem] lg:space-x-[12rem] ' >
            <div className='space-y-1 md:space-y-4 space-x-0 mb-4'>
              <div className='flex text-drwht text-lg space-x-5 items-center justify-center'>
                <PhoneIcon className='h-6 w-6 text-base md:text-lg text-Color1' />
                <p>+44 7448 454294</p>
              </div>
              <div className='flex text-drwht text-base md:text-lg  space-x-5 items-center justify-center '>
              ...
              <div className="flex justify-around items-center py-2 md:py-8 text-Color1">
                <div className="flex flex-col items-center">
                  <WrenchIcon className=" h-8 w-8 md:w-12 md:h-10 md:h-12 text-blue-600" />
                  <p className="mt-2 text-lg font-semibold">Renovate</p>
                </div>
                <div className="w-[2px] hidden md:flex h-28 bg-Color1 mx-0 md:mx-8"></div>

                <div className="flex flex-col items-center">
                  <PencilIcon  className=" h-8 w-8 md:w-12 md:h-10 md:h-12  text-blue-600" />
                ...
                <div className="flex flex-col items-center">
                  <HomeIcon  className=" h-8 w-8 md:w-12 md:h-10 md:h-12  text-blue-600" />
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-2 lg:space-y-4 w-[300px] md:w-[360px]' action="">
              <div className='space-x-2 flex '>
                <input className='inputbox h-10 md:h-12 px-2 w-[48%] md:w-[175px]'
                  type="text" required
                ...
                <input
                  ...
                  className='inputbox h-10 md:h-12 px-2 w-[48%] md:w-[175px]'
                  type="text"
                  {...register("lastName")}
              ...
              <input required
                placeholder='Email'
                className='inputbox px-2 h-10 md:h-12'
                type="email"
                {...register("email")}
              ...
              <input
                placeholder='Subject'
                className='inputbox h-10 md:h-12 px-2'
                type="text"
                {...register("subject")}
              ...
              <textarea required
                placeholder='Message'
                className='inputbox h-12 md:h-16 px-2'
                id="" {...register("message")}
