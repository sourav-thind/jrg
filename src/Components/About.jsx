...
const About = () => {
  return (
    <section className="bg-Color2 min-h-screen w-screen left-0 *:">
    ...
    <div className="py-8 px-6 mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-[80%] mx-auto">
        <div className=" bg-Color1 text-white shadow-lg p-6 rounded-lg text-center">
        ...
        {/* Professionalism */}
        <div className="bg-white shadow-lg p-6 rounded-lg text-center text-Color1">
    ...
    <div
        ...
        style={{ backgroundImage: Estimate }}
      ></div>
